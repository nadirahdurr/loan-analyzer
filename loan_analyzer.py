...
print(f"There are {total_number_of_loans} loans on the list.")
...
print(f"The sum of loans on the list is ${sum_of_loans}.")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount

average_loan_amount = float(sum_of_loans/total_number_of_loans)
...
for loan in loans: 
    if not loan.get("loan_price") > 500:
